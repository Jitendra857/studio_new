...
namespace PIOAccount.Classes
{
    public class DbConnection
    {
        ...
        //<<<<<<< HEAD
        public static string ConnectionString = "Server=144.91.71.201;Database=Test_Studio;User ID=Piosun;Password=pio*123";
        //public static string ConnectionString = "Server=144.91.71.201;Database=Studio;User ID=Piosun;Password=pio*123";
        ...
        public DataTable CallStoreProcedure(string procedurename, SqlParameter[] parameters)
        {
            ...
            try
            {
                ...
                if (parameters != null && parameters.Length > 0)
                {
                    ...
                    {
                        newParameters[i] = new SqlParameter(parameters[i].ParameterName, parameters[i].Value)
                        {
        ...
        //public static List<SelectListItem> GetClientList(int ClientId, int isadministrator = 0, int CompanyId=0)
        public static List<SelectListItem> GetClientList(int CompanyId, int isadministrator = 0, int ClientId = 0)
        {
            DbConnection objdb = new DbConnection();
            List<SelectListItem> list = new List<SelectListItem>();
            SqlParameter[] sqlParameters = new SqlParameter[2];

            ...
            try
            {
                ...
                if (id > 0)
                {
                    ...
                    if (DtCompany != null && DtCompany.Rows.Count > 0)
                    {
                        ...
                        companyMasterModel.MainLngID = 0; //Convert.ToInt32(DtCompany.Rows[0]["CmpLang"].ToString());
                        companyMasterModel.DataLngID = 0; //Convert.ToInt32(DtCompany.Rows[0]["CmpDataLang"].ToString());

...
namespace Soc_Management_Web.Controllers
{
        ...
        public IActionResult Index(long id, string type = null)
        {
            try
            {
                ...
                if (id > 0)
                {
                    ...
                    sqlParameters[0] = new SqlParameter("@flag", 2);//3
                    ...
                    if (DtEmp != null && DtEmp.Rows.Count > 0)
                    {
                        ...
                        contactmodel.Date = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccDate"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccDate"].ToString()).ToString("yyyy-MM-dd") : "";
                        ...
                        contactmodel.RefBy = DtEmp.Rows[0]["AccRef"].ToString();
                        contactmodel.Group = DtEmp.Rows[0]["AccGroup"].ToString();
                        ...
                        contactmodel.Birthdate1 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccBirthDt"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccBirthDt"].ToString()).ToString("yyyy-MM-dd") : "";

                        contactmodel.Birthdate2 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccBirthDt2"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccBirthDt2"].ToString()).ToString("yyyy-MM-dd") : "";
                        contactmodel.Birthdate3 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccBirthDt3"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccBirthDt3"].ToString()).ToString("yyyy-MM-dd") : "";
                        contactmodel.Birthdate4 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccBirthDt4"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccBirthDt4"].ToString()).ToString("yyyy-MM-dd") : "";

                        contactmodel.Marrigedate1 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccMariageDt"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccMariageDt"].ToString()).ToString("yyyy-MM-dd") : "";

                        contactmodel.Marrigedate2 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccMariageDt2"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccMariageDt2"].ToString()).ToString("yyyy-MM-dd") : "";
                        contactmodel.Marrigedate3 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccMariageDt3"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccMariageDt3"].ToString()).ToString("yyyy-MM-dd") : "";
                        contactmodel.Marrigedate4 = !string.IsNullOrWhiteSpace(DtEmp.Rows[0]["AccMariageDt4"].ToString()) ? Convert.ToDateTime(DtEmp.Rows[0]["AccMariageDt4"].ToString()).ToString("yyyy-MM-dd") : "";
                        ...
                        contactmodel.City = DtEmp.Rows[0]["AccCtyNm"].ToString();
                        contactmodel.Pin_code = DtEmp.Rows[0]["AccPIN"].ToString();
                ...
                {
                    contactmodel.Code = objProductHelper.GetMaxCode(companyId) + 1;
                    contactmodel.Date = System.DateTime.Now.ToString("yyyy-MM-dd");
                    contactmodel.Category =1;
                }
                //else
                //{
                //    contactmodel.Code = getrenadomkey();
                ...
                var groupList = objProductHelper.GetGroupList(companyId)
    ...
    .ToList();
                ...
                contactmodel.lstGroup = groupList;// objProductHelper.GetAreaList().OrderBy(x => x.Text).ToList();
     ...
     .ToList();
                ...
                var areaList = objProductHelper.GetAreaList(companyId)
    .Where(x => !string.IsNullOrWhiteSpace(x.Text))
    .OrderBy(x => x.Text)
     .GroupBy(x => x.Text, StringComparer.OrdinalIgnoreCase)  // Use a case-insensitive comparer if needed
     .Select(g => g.First())
    ...
    .ToList();
                ...
                var areaList1 = objProductHelper.GetlstRefByDropdown(companyId)
.Where(x => !string.IsNullOrWhiteSpace(x.Text))
.OrderBy(x => x.Text)
.ToList();
        ...
        public IActionResult Index(long id, ContactModel contactmodel)
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(contactmodel.Name))
                {
                    ...
                    sqlParameters[35] = new SqlParameter("@CmpVou", companyId);
                    ...
                    if (DtCity != null && DtCity.Rows.Count > 0)
                    {
                        ...
                        if (status == -1)
                        {
                            ...
                            ViewBag.FocusType = "-1";
                            contactmodel.lstcategory = objProductHelper.GetCategoryDropdown(companyId).OrderBy(x => x.Text).ToList();
                            contactmodel.lstGroup = objProductHelper.GetGroupDropdown().OrderBy(x => x.Text).ToList();
                            ...
                            contactmodel.lstRefBy = objProductHelper.GetlstRefByDropdown(companyId).OrderBy(x => x.Text).ToList();

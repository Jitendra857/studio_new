    ...
    public class EventStatusController : BaseController
    {
        ...
        public JsonResult GetListData(OrdEventStatus sc)
        {
            ...
            int companyId = Convert.ToInt32(GetIntSession("CompanyId"));
                ...
                sqlParameters[12] = new SqlParameter("@CmpVou", companyId);

        ...
        public IActionResult Index(long id)
        {
            try
            {
                ...
                if (id > 0)
                {
                    ...
                    PrsqlParameters[2] = new SqlParameter("@CmpVou", companyId);
                    ...
                    SqlParameter[] MnsqlParameters = new SqlParameter[3];
                    MnsqlParameters[0] = new SqlParameter("@JobVou", id);
                    MnsqlParameters[1] = new SqlParameter("@Flg", 6);
                    MnsqlParameters[2] = new SqlParameter("@CmpVou", companyId);
                ...
                jobmdel.lstcategory = objProductHelper.GetCategoryDropdown(companyId).OrderBy(x => x.Text).ToList();
                jobmdel.lstproduct = objProductHelper.GetlstProdDropdown(companyId).OrderBy(x => x.Text).ToList();
                ViewBag.FocusType = "0";
        ...
        public ActionResult Index(JobModel _customer)//long id,
        {
            try
            {
                ...
                if (!string.IsNullOrWhiteSpace(_customer.jobworkname))
                {
                    ...
                    sqlParameters[7] = new SqlParameter("@CmpVou", companyId);
                    ...
                    if (DtCity != null && DtCity.Rows.Count > 0)
                    {
                        ...
                        if (status == -1)
                        {
                           // TempData["reload"] = 0;
                            ...
                            //_customer.StateList = objProductHelper.GetStateMasterDropdown(companyId, administrator); 
                        ...
                        else
                        {
                            ...
                            if (_customer.lstProduct1 != null)
                            {
                                ...
                                foreach (var item in ItemList)
                                {
                                    ...
                                    SqlParameter[] PrsqlParameters = new SqlParameter[7];
                                    ...
                                    PrsqlParameters[6] = new SqlParameter("@CmpVou", companyId);
                            ...
                            if (_customer.lstMainPower != null)
                            {
                                ...
                                foreach (var item in ItemList1)
                                {
                                    ...
                                    SqlParameter[] MainsqlParameters = new SqlParameter[7];
                                    ...
                                    MainsqlParameters[6] = new SqlParameter("@CmpVou",companyId);
                            ...
                            return RedirectToAction("index", "JobMaster", new { id = 0 });
        ...
        public IActionResult Delete1(int jobvou, int sno, int type)
        {
            try
            {
                ...
                if (type == 1)
                {
                    ...
                    PrsqlParameters[3] = new SqlParameter("@CmpVou", companyId);

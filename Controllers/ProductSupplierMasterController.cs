    ...
    public class ProductSupplierMasterController : BaseController
    {
        ...
        public IActionResult Index(long id)
        {
            try
            {
                ...
                prSupModel.lstProductList = objProductHelper.GetProductDropdown(companyId).OrderBy(x => x.Text).ToList();
                prSupModel.lstSupplierList = objProductHelper.GetSupplierDropdown(companyId).OrderBy(x => x.Text).ToList();
